...
class EditPolicyPayment extends EditRecord
{
    ...
    protected function isLocked(): bool
    {
        ...
        return in_array(mb_strtolower($status), ['paid', 'overdue', 'refunded', 'canceled'], true);
    }
    ...
    protected function notifyLock(): void
    {
        Notification::make()
            ...
            ->body('Платіж має фінальний статус: сплачено, протерміновано, повернено або скасовано. Зміни та видалення недоступні.')
